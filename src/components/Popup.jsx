...
const PopUp = ({ setShowPopUp, showPopUp, getmembers }) => {
  ...
  return (
      <>
        ...
        <main id="content" role="main" className="border-gray-300 border-4 rounded mx-auto mt-[6rem] overflow-auto max-h-[80vh] shadow-sm shadow-white   w-[100%]   max-w-[40rem]  ">
          {
                ...
                <form action="" onSubmit={handleSubmit}>
                  <div className="grid  grid-cols-2 gap-2 sm:gap-4 ">
                    ...
                    <div className={`${imageUrl ? "flex items-center":""} col-span-2 `}>
                      ...
                      <p
                          className={`text-xs text-red-600 mt-2 ${message.requireImage ? "" : "hidden"
                          }`}
                      >
